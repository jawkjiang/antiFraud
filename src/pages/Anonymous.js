...
function Anonymous() {
  const leftColumnData = [
    {
      id: 1,
      img: `${process.env.PUBLIC_URL}/images/anonymous/用户1.png`,
    ...
    {
      id: 2,
      img: `${process.env.PUBLIC_URL}/images/anonymous/用户2.png`,
    ...
    {
      id: 3,
      img: `${process.env.PUBLIC_URL}/images/anonymous/用户3.png`,
    ...
    {
      id: 4,
      img: `${process.env.PUBLIC_URL}/images/anonymous/用户4.png`,
  ...
  const rightColumnData = [
    {
      id: 1,
      img: `${process.env.PUBLIC_URL}/images/anonymous/头像1.jpg`,
      name: "阿宇说故事",
      description: "资深反诈专家，擅长电信诈骗与金融犯罪分析。",
    },
    {
      id: 2,
      img: `${process.env.PUBLIC_URL}/images/anonymous/头像2.jpg`,
      name: "小桐的探索",
    ...
    {
      id: 6,
      img: `${process.env.PUBLIC_URL}/images/anonymous/头像6.jpg`,
      name: "创意工作坊",
